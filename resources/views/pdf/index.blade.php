...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('pdf-export-assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('pdf-export-assets/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('pdf-export-assets/css/app.css') }}">
</head>

<body style="margin:0 0 90px 0;padding:0;direction:rtl;text-align:right;font-family:'iransans';">
    <div style="width:100%;">
        <table
            ...
            <tbody style="display:block;position:relative;">
                <tr style="display:block;position:relative;padding-left:30px;padding-right:30px;">
                    <td style="display:block;">
                        <div style="clear:both;display:block;margin-right:34px;">
                            <div style="width:25%;float:left;position:relative;min-height: 1px;">
                                <img src="{{ asset('pdf-export-assets/images/logo-left.png') }}"
                            ...
                            <div style="width:25%;padding-left:15px;float:left;min-height:1px;position:relative;">
                                <img src="{{ asset('pdf-export-assets/images/apple.png') }}"
                ...
                <tr style="display:block;position:relative;padding-left:25px;padding-right:25px;">
                ...
                <tr style="display:block;position:relative;padding-left: 23px;padding-right:25px;">
                    <td style="width:100%;display:table;margin-top:5px;font-size:10px;">
                        <span
                            style="width:25px;height:100%;writing-mode:vertical-lr;-webkit-writing-mode:vertical-lr;-ms-writing-mode:tb-rl;line-height:25px;text-align:center;position:absolute;top:0;z-index:2;right: 31px;background-color:#0000ff;color:#ffffff;transform:rotate(180deg);font-size:11px;">
                            مشخصات بیمه نامه مورد در خواست
                ...
                display:block;position:relative;border-collapse: separate; border-spacing: 2px;">
                                    <tbody style="display: table;width:100%;">
                                        <tr>
                                            ...
                                            <td
                                                style="text-align:center;color:#184727;padding:2px;font-size:11px;font-weight:bold;border:1px solid #000000;">
                                                <table
                                                    style="page-break-inside:avoid;width:100%;display:block;position:relative;">
                                                    <tbody style="display:table;width:100%;">
                                                        <tr>
                                                            <td colspan="12">
                                                                <div>
                ...
                <tr style="display:table;width:100%;position:relative;margin-top:5px;">
                ...
                <tr style="display:table;width:100%;position:relative;">
                    <td
                    ...
                    <td style="width:100%;display:table;margin-top:5px;font-size:10px;">
                        <div style="padding: 0 5px 0 1px;color:#000000;display: block;">
                            <div
                                ...
                                <table style="page-break-inside:avoid;width:100%;display:block;position:relative;">
