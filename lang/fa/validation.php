...
return [
    ...
    'confirmed'            => 'رمزعبور با فیلد تکرار مطابقت ندارد.',
    ...
    'current_password' => 'رمزعبور اشتباه است.',
    'password' => [
        'letters' => 'رمزعبور باید شامل حداقل یک حرف انگلیسی باشد.',
        'mixed' => 'رمزعبور باید شامل حرف بزرگ و کوچک باشد.',
        'numbers' => 'رمزعبور باید شامل حداقل یک عدد باشد.',
        'symbols' => 'رمزعبور باید شامل حداقل یک سیمبل انگلیسی باشد.',
        'uncompromised' => 'رمزعبور ضعیف است، یک رمزعبور دیگر انتخاب کنید.',
    ],
